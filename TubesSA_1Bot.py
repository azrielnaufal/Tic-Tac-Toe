            ...
            if not game_over:
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if available_square(clicked_row,clicked_col):
                        mark_square(clicked_row,clicked_col,1)#harusnya di isi player -> 1, tapi kalo pake player eror!!
                        if check_win(1):#harusnya di isi player -> 1, tapi kalo pake player eror!!
                            game_over = True
                            winning_Line(1)#harusnya di isi player -> 1, tapi kalo pake player eror!!
                        compMove()
                        if check_win(2):#harusnya di isi bot -> 2, tapi kalo pake player eror!!
                            game_over = True
                            winning_Line(2)#harusnya di isi bot -> 2, tapi kalo pake player eror!!
